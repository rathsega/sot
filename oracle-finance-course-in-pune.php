...
<body>
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30" id="overview">
                            <div class="rbt-course-feature-inner">
                                <div class="section-title">
                                    <h2 class="rbt-title-style-3">About
                                        <?php echo $course_details[$current_slug]['title'] ?></h2>
                                </div>
                                <!-- Overview Start -->
    ...
    <h2 class="about-heading">
      Why <span class="gradient-text">Oracle Fusion Financials</span> Has Strong Demand in Pune
    </h2>

    <p class="about-description">
     Organizations in Pune rely on structured finance systems to manage operations and reporting.
    </p>
    <p class="about-description">
     <strong> Reasons to learn Oracle Fusion Financials in Pune: </strong>
    </p>
          <ul class="location-points">
        <li><h3>Growing use of cloud ERP in manufacturing finance</h3></li>
        <li><h3>Demand for finance professionals with ERP exposure</h3></li>
        <li><h3>Need for standardized accounting and reporting</h3></li>
        <li><h3>Expansion of corporate finance roles</h3></li>
      </ul>
  </div>

  <div class="about-content mt--30">
    <h2 class="about-heading">
      What You Will <span class="gradient-text">Learn </span> in Oracle Fusion Financials Online Course
    </h2>
     <p class="about-description">
     <strong>You will gain knowledge in: </strong>
    </p>
          <ul class="location-points">
        <li><h3>Accounting structures and ledger processes</h3></li>
        <li><h3>Payables, receivables, and asset accounting</h3></li>
        <li><h3>Financial reporting and reconciliation</h3></li>
        <li><h3>Compliance and control basics</h3></li>
        <li><h3>Cloud financial system navigation</h3></li>
      </ul>
      <p>The focus is on applying finance concepts in enterprise environments.</p>
  </div>

  <div class="who-header">
    <span class="who-label">Who It's For</span>
    <h2 class="who-heading">
    PUNE – Who Should <span class="gradient-text">Enroll </span>in This Oracle Fusion Finance Training?
    </h2>
  </div>
  ...
  <div class="who-grid">
    ...
    <div class="who-card">
      ...
      <h3>Graduates & Entry-Level Finance Professionals</h3>
      <p>Candidates looking to build job-ready skills in Oracle Fusion Financials Cloud.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <h3>Qualified Commerce Graduates</h3>
      <p>CA, CMA, MBA Finance, and M.Com graduates strengthen profiles with ERP training.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <p> Professionals planning to upgrade from Oracle EBS Financials to Oracle Fusion Financials Cloud environments.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <p> ERP professionals aiming to expand into Oracle Financials Cloud implementation and support roles.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <h3>Business & Finance Managers</h3>
      <p>Managers seeking a system-level understanding of Oracle Financials to support finance transformation programs.</p>
    </div>
...
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <path d="M14 8h6v6"></path>
      ...
      <p>Individuals transitioning from traditional accounting or non-ERP roles into Oracle Cloud finance careers.</p>
    </div>
   ...
   <div class="highlights-header">
    ...
    <p>This Oracle Fusion Financials training in Pune is designed to deliver practical ERP finance skills.</p>
  </div>
  ...
  <div class="highlights-grid">
    ...
    <div class="highlight-card">
      ...
      <h3>Enterprise Financial Use Cases</h3>
      <p>Learn finance processes commonly followed by organizations.
</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p> Practice Oracle Fusion Financials configurations in cloud labs.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Certificate that enhances your finance professional profile.
</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Continue Oracle Fusion training using a mobile app with recorded classes and LMS support.</p>
    </div>
...
<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <path d="M3 21c0-4 3-7 6-7"></path>
      ...
      <p>Career guidance aligned with Oracle Financials roles in Pune.
</p>
    </div>
    ...
    <h2 class="why-heading">
      Why Choose This Oracle Financials Training in <span class="gradient-text">Pune</span>
    </h2>
    <p>Oracle Fusion Financials training in Pune focuses on real-world finance system understanding.
</p>
  </div>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" viewBox="0 0 512 512">
  ...
  <div>
    <h2>Pune</h2>
    <p>Financial Cloud Expertise</p>
  </div>
</div>

<ul class="trainer-points">
  <li><h3>Many global capability centers in Pune operate Oracle Fusion Financials systems for enterprise finance operations</h3></li>
  <li><h3>Companies seek professionals skilled in cloud-based accounting and financial reporting tools</h3></li>
  <li><h3>Professionals with Oracle Financials expertise can build careers within Pune’s consulting and technology sectors</h3></li>
</ul>
    ...
    <div class="why-features">
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Practical Financials Training Approach</h3>
          <p>Focus on how Oracle Financials is applied in organizations.</p>
        </div>
      </div>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Trainers with Oracle Financials Project Knowledge</h3>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Complete Financial Process Coverage</h3>
          <p> Covers major finance functions and reporting flows.</p>
        </div>
      </div>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Updated Oracle Cloud Standards</h3>
    ...
    <span class="gradient-text"> Career Opportunities </span> in Pune After Oracle Financials Training
    </h2>
      <p class="about-description"><strong> Learners can explore roles such as: </strong></p>
        ...
        <li><h3>Finance Operations Analyst</h3></li>
        <li><h3>ERP Financials Support Professional</h3></li>
        <li><h3>Accounting Systems Specialist</h3></li>
      </ul>
      <p>Oracle Fusion Financials expertise supports long-term career growth in Pune.</p>
  </div>
                        </div>
                        <!-- End Course Feature Box  -->
