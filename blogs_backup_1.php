                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="blog-details.php?blog=<?php echo convertTitleToURL($blog['title']); ?>&id=<?php echo $blog['blog_id']; ?>">
                                            <img src="<?php echo 'https://admin.softonlinetraining.com/uploads/blog/thumbnail/' . $blog['thumbnail']; ?>" alt="<?php echo $blog['title']; ?>"> </a>
                                    </div>
                                    <div class="rbt-card-body">
                                        <h5 class="rbt-card-title"><a href="blog-details.php?blog=<?php echo convertTitleToURL($blog['title']); ?>&id=<?php echo $blog['blog_id']; ?>"><?php echo $blog['title']; ?></a></h5>
                                        ...
                                        <div class="rbt-card-bottom">
                                            <a class="transparent-button" href="blog-details.php?blog=<?php echo convertTitleToURL($blog['title']); ?>&id=<?php echo $blog['blog_id']; ?>">Learn
                            ...
                            <div class="inner">
                                ...
                                <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                    <?php foreach ($recent_blogs as $blog) : ?>
                                        <li>
                                            <div class="thumbnail">
                                                <a href="blog-details.php?id=<?php echo $blog['blog_id']; ?>">
                                                    <img src="<?php echo 'https://admin.softonlinetraining.com/uploads/blog/thumbnail/' . $blog['thumbnail']; ?>" alt="<?php echo $blog['title']; ?>">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="title"><a href="blog-details.php?id=<?php echo $blog['blog_id']; ?>"><?php echo $blog['title']; ?></a></h6>
                                                <ul class="rbt-meta">
                                                    <li><i class="feather-clock"></i><?php echo date('F j, Y', $blog['added_date']); ?></li>
                                                </ul>
                                            </div>
