...
<body>
    ...
    <h2 class="about-heading">
      What is <span class="gradient-text">Oracle Fusion OTM?</span>
    </h2>

    <p class="about-description">
      Oracle Transportation Management (OTM) is an enterprise transportation management system designed to plan, execute, and optimize logistics operations across global supply chains. It helps organizations manage inbound and outbound shipments, select optimal carriers, control freight costs, and track transportation performance.
    </p>

    <p class="about-description">
      Oracle OTM supports transportation planning, rate and contract management, shipment execution, tracking, and freight payment. By providing real-time visibility and optimization capabilities, the platform enables organizations to improve delivery reliability, reduce transportation spend, and manage logistics operations efficiently across regions.
    </p>
    <p class="about-description">Oracle Transportation Management training prepares professionals to manage complex transportation operations within a cloud-enabled logistics environment. As organizations aim to optimize freight movement, reduce logistics costs, and improve delivery performance, Oracle OTM plays a critical role in end-to-end transportation planning and execution.</p>
    <p class="about-description">This training focuses on real transportation workflows such as shipment planning, rate management, carrier selection, execution, and freight settlement. Learners gain practical exposure to how transportation processes are configured and managed within Oracle OTM, enabling them to support logistics operations aligned with real business requirements and certification paths.</p>
  </div>

  <h3 class="who-label" style="margin-top:20px;">Key Modules</h3>
<div class="tag-container">
  <div class="tag">Logistics Inbound</div>
  <div class="tag">Logistics Outbound</div>
  <div class="tag">Transactional Data</div>
  <div class="tag">Master Data</div>
  <div class="tag">OTM Technical</div>
  <div class="tag">Technical Architecture</div>
  <div class="tag">OTM Financials</div>
  <div class="tag">Fleet Monitoring</div>
</div>
  ...
  <div class="who-header">
    ...
    <h2 class="who-heading">
      Who Should <span class="gradient-text">Enroll </span>in This Oracle Fusion OTM Course?
    </h2>
    <p>This Oracle Transportation Management training is ideal for professionals involved in logistics, transportation planning, and supply chain execution.</p>
  </div>
  ...
  <div class="who-grid">
    ...
    <div class="who-card">
      ...
      <p>Candidates interested in building careers in transportation management systems and logistics operations.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <h3>Logistics & Transportation Professionals</h3>
      <p> Transportation planners, logistics executives, and freight coordinators seeking system-level expertise.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <h3>Supply Chain & Distribution Professionals</h3>
      <p>Professionals managing inbound and outbound logistics who want deeper insight into transportation systems.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <p>Consultants looking to specialize in Oracle OTM implementation and support projects.</p>
    </div>
    ...
    <div class="who-card">
      ...
      <h3>Operations & Freight Management Teams</h3>
      <p> Professionals responsible for carrier coordination, shipment execution, and freight cost control.</p>
    </div>
...
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <path d="M14 8h6v6"></path>
      ...
      <h3>Non-Technical Background</h3>
      <p>A fundamentals-first learning path created for non-IT professionals entering Oracle ERP and Cloud platforms.</p>
    </div>
   ...
   <div class="highlights-header">
    ...
    <h2 class="highlights-heading">
      Oracle Fusion OTM Course <span class="gradient-text">Highlights</span>
    </h2>
    <p>This Oracle Transportation Management training is designed to help learners understand logistics planning, execution, and freight optimization using Oracle OTM.
</p>
  </div>
  ...
  <div class="highlights-grid">
    ...
    <div class="highlight-card">
      ...
      <p>Attend live instructor-led sessions and access recorded classes for one year to revise transportation flows, configurations, and core OTM concepts.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <h3>Hands-On OTM Use Cases</h3>
      <p>Learn through real-world transportation scenarios such as shipment planning, freight costing, carrier selection, and delivery execution.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Get hands-on practice in Oracle Transportation Management Cloud, working on shipments, rates, itineraries, and transportation rules.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Begin with OTM fundamentals and move step-by-step toward advanced transportation planning, automation, and optimization concepts.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Receive interview preparation, real-time scenario discussions, and role-based guidance aligned with Oracle OTM job requirements.</p>
    </div>
    ...
    <div class="highlight-card">
      ...
      <p>Earn a course completion certificate that validates your Oracle OTM functional skills and strengthens your professional profile.</p>
    </div>
    ...
    <p>This Oracle OTM online training focuses on practical transportation management workflows used by logistics-driven organizations.</p>
  </div>
  ...
  <div class="why-container">
    ...
    <div class="trainer-card">
      <div class="trainer-header">
        ...
        <div>
          <h2>Mr. Abhiram</h2>
          <p>Oracle OTM Expert</p>
        </div>
      </div>

      <ul class="trainer-points">
        <li><h3>Domain expert with 14+ years of experience in logistics, transportation, and global trade systems</h3></li>
        <li><h3>Strong expertise in freight planning, shipment execution, and transportation compliance</h3></li>
        <li><h3>Ideal for professionals from logistics, supply chain, and EXIM backgrounds</h3></li>
        <li><h3>Covers real-world transportation and cross-border logistics scenarios</h3></li>
      </ul>
    ...
    <div class="why-features">
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Transportation Process–Focused Training</h3>
          <p>Learn how Oracle Transportation Management is used to manage freight, carriers, routes, and delivery operations in real enterprises.</p>
        </div>
      </div>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Trainer with OTM Implementation Experience</h3>
          <p>Training is delivered by professionals who have worked on live Oracle OTM implementation and support projects.</p>
        </div>
      </div>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>End-to-End OTM Coverage</h3>
          <p>Covers shipment planning, execution, freight settlement, carrier management, and integration with SCM and financial modules.</p>
        </div>
      </div>
      ...
      <div class="feature-item">
        ...
        <div>
          <h3>Aligned with Current Oracle OTM Practices</h3>
          <p>Content reflects current Oracle Transportation Management Cloud features and industry-standard logistics workflows.</p>
        </div>
      </div>
...
<table class="career-table">
  ...
  <tbody class="Career-Outcomes">
    <tr class="career-Outcome">
      <td><h3>OTM Functional Consultant</h3></td>
      <td>₹8-18 LPA</td>
      <td>$85-130K</td>
      <td>£50-80K</td>
    </tr>
    ...
    <tr class="career-Outcome">
      <td><h3>OTM Technical Consultant</h3></td>
      <td>₹10-22 LPA</td>
      <td>$90-140K</td>
      <td>£55-90K</td>
    </tr>
